...
export function Settings() {
  ...
  function handleThingsYouMissedChange() {
    updateData({
      updatesFromKeenthemes: {
        ...data.updatesFromKeenthemes,
        thingsYouMissed: !data.updatesFromKeenthemes.thingsYouMissed,
      },
    })
  }
  ...
  function handleMemberRegistrationChange() {
    updateData({
  ...
  function handleNewMembershipApprovalChange() {
    updateData({
      activityRelatedEmail: {
        ...data.activityRelatedEmail,
        whenToEscalateEmails: {
  ...
  function handleUponNewOrderChange() {
    updateData({
      activityRelatedEmail: {
        ...data.activityRelatedEmail,
        whenToEscalateEmails: {
          ...data.activityRelatedEmail.whenToEscalateEmails,
          uponNewOrder: !data.activityRelatedEmail.whenToEscalateEmails.uponNewOrder,
        },
      },
    })
  }

  function handleSomeoneAddsYouAsAConnectionChange() {
    updateData({
      activityRelatedEmail: {
        ...data.activityRelatedEmail,
        whenToEmail: {
  ...
  function handleYouAreADirectMessageChange() {
    updateData({
      activityRelatedEmail: {
        ...data.activityRelatedEmail,
        whenToEmail: {
          ...data.activityRelatedEmail.whenToEmail,
          youAreADirectMessage: !data.activityRelatedEmail.whenToEmail.youAreADirectMessage,
        },
      },
    })
  }

  function handleYouHaveNewNotificationsChange() {
    updateData({
      activityRelatedEmail: {
        ...data.activityRelatedEmail,
        whenToEmail: {
  ...
  function handleSendCopyToPersonalEmailChange() {
    updateData({
  ...
  function handleEmailNotificationsChange() {
    updateData({
      setupEmailNotifications: {
        ...data.setupEmailNotifications,
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid form-switch'>
                <input
                  ...
                  onChange={handleSendCopyToPersonalEmailChange}
                />
              </div>
            </div>
          </div>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  onChange={handleYouHaveNewNotificationsChange}
                />
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  onChange={handleYouAreADirectMessageChange}
                />
              ...
              <div className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleSomeoneAddsYouAsAConnectionChange}
                />
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  onChange={handleUponNewOrderChange}
                />
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  onChange={handleNewMembershipApprovalChange}
                />
              ...
              <div className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleMemberRegistrationChange}
                />
            ...
            <div className='col-lg-9 col-xl-6'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                <input
                  ...
                  onChange={handleThingsYouMissedChange}
                />
