...
const InboxCompose: React.FC<Props> = ({show, handleClose}) => {
  ...
  const handleComposeBCCChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setComposeBCC(e.target.value)
  }

  const handleComposeCCChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    ...
    >
      <div className='modal-content'>
        {/* begin::Form */}
        <form ref={formRef} id='kt_inbox_compose_form'>
          {/*begin::Header*/}
            ...
            <div className='d-none align-items-center border-bottom inbox-to-cc ps-8 pe-5 min-h-45px'>
              ...
              <div className='flex-grow-1'>
                <input
                  ...
                  name='compose_cc'
                  value={composeCC}
                  onChange={handleComposeCCChange}
                />
              </div>
            ...
            <div className='d-none align-items-center border-bottom inbox-to-bcc ps-8 pe-5 min-h-45px'>
              ...
              <div className='flex-grow-1'>
                <input
                  ...
                  name='compose_bcc'
                  value={composeBCC}
                  onChange={handleComposeBCCChange}
                />
              </div>
