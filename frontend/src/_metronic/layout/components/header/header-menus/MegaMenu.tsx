...
const MegaMenu: FC = () => {
  ...
  const selectReportsToolbar = () => setToolbarType('reports')
  const selectExtendedToolbar = () => setToolbarType('extended')
  const selectAccountingToolbar = () => setToolbarType('accounting')
  const selectSaasToolbar = () => setToolbarType('saas')
  const selectClassicToolbar = () => setToolbarType('classic')
  const selectDarkHeaderLayout = () => setLayoutType('dark-header')
  const selectLightHeaderLayout = () => setLayoutType('light-header')
  const selectDarkSidebarLayout = () => setLayoutType('dark-sidebar')
  const selectLightSidebarLayout = () => setLayoutType('light-sidebar')
        ...
        <div className='row'>
          ...
          <div className='col-lg-6 mb-3'>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectLightSidebarLayout} className='menu-link'>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectDarkSidebarLayout} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectLightHeaderLayout} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectDarkHeaderLayout} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
          ...
          <div className='col-lg-6 mb-3'>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectClassicToolbar} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectSaasToolbar} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectAccountingToolbar} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectExtendedToolbar} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
            ...
            <div className='menu-item p-0 m-0'>
              {/* begin:Menu link */}
              <a onClick={selectReportsToolbar} className='menu-link'>
                <span className='menu-bullet'>
                  <span className='bullet bullet-dot bg-gray-300i h-6px w-6px'></span>
                </span>
