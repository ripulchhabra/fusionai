...
const BuilderPage: React.FC = () => {
  ...
  const handleDesktopHoverChange = () => {
    const con = {...config}
    if (
      con.app &&
      con.app.sidebar &&
  ...
  const handleDesktopFixedChange = () => {
    const con = {...config}
  ...
  const handleToolbarClick = () => setTab('Toolbar')
  const handleHeaderClick = () => setTab('Header')
  const handleSidebarClick = () => setTab('Sidebar')
                    ...
                    mb-2'
                      >
                        <input
                          ...
                          onChange={handleDesktopFixedChange}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  '
                      >
                        <input
                          ...
                          onChange={handleDesktopHoverChange}
                        />
                        <label
                          className='form-check-label text-gray-700 fw-bold'
