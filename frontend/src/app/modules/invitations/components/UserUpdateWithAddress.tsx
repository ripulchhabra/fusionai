...
export const UserUpdateWithAddress = (props: any) => {
  ...
  const createCloseUserUpdateDialog = (value: boolean) => () => props.setShowUserUpdateDialog(value)

  const createRoleSetter = (role: string) => () => setRole(role)

  const createPhoneChangeHandler =
    (type: 'Company' | 'Mobile') => (e: React.ChangeEvent<HTMLInputElement>) =>
      handlePhoneNumberChange(type, e)

  const createCountryChangeHandler =
    (formik: FormikProps<AdminUserDetailModel>) => (value: string, countryData: CountryData) =>
              ...
              <div id='kt_modal_update_user_user_info' className='show'>
                ...
                <div className='fv-row mb-7'>
                  ...
                  {formik.touched.firstname && formik.errors.firstname && (
                    <div className='fv-help-block text-danger mt-1'>{formik.errors.firstname}</div>
                  )}
                </div>
                ...
                <div className='fv-row mb-7'>
                  ...
                  {formik.touched.lastname && formik.errors.lastname && (
                    <div className='fv-help-block text-danger mt-1'>{formik.errors.lastname}</div>
                  )}
                </div>
                ...
                <div className='fv-row mb-7'>
                  ...
                  {formik.touched.email && formik.errors.email && (
                    <div className='fv-help-block text-danger mt-1'>{formik.errors.email}</div>
                  )}
                </div>
