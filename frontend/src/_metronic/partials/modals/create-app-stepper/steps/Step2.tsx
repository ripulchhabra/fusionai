...
import {StepProps, TAppFramework} from '../IAppModels'

const Step2 = ({data, updateData}: StepProps) => {
  const handleUpdateFramework = (framework: TAppFramework) => () => {
    updateData({appFramework: framework})
  }
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input
                ...
                onChange={handleUpdateFramework('HTML5')}
              />
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input
                ...
                onChange={handleUpdateFramework('ReactJS')}
              />
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input
                ...
                onChange={handleUpdateFramework('Angular')}
              />
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input
                ...
                onChange={handleUpdateFramework('Vue')}
              />
            </span>
          </label>
          {/*end::Option */}
