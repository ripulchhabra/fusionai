...
const Step3 = ({data, updateData, hasError}: StepProps) => {
  ...
  const handleUpdateDatabase =
    (dbName: string, solution: 'MySQL' | 'Firebase' | 'DynamoDB') => () => {
      updateData({
        appDatabase: {
          databaseName: dbName,
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateDatabase(data.appDatabase.databaseName, 'MySQL')}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateDatabase(data.appDatabase.databaseName, 'Firebase')}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateDatabase(data.appDatabase.databaseName, 'DynamoDB')}
                />
              </span>
            </label>
            {/*end::Option */}
