...
const Step1 = ({data, updateData, hasError}: StepProps) => {
  ...
  const handleUpdateAppType =
    (
      name: string,
      type: 'Quick Online Courses' | 'Face to Face Discussions' | 'Full Intro Training'
    ) =>
    () => {
      updateData({
        appBasic: {
            ...
            <label className='d-flex align-items-center justify-content-between mb-6 cursor-pointer'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateAppType(data.appBasic.appName, 'Quick Online Courses')}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between mb-6 cursor-pointer'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateAppType(data.appBasic.appName, 'Face to Face Discussions')}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between mb-6 cursor-pointer'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleUpdateAppType(data.appBasic.appName, 'Full Intro Training')}
                />
              </span>
            </label>
            {/*end::Option */}
