...
const ToolbarClassic = () => {
  ...
  const closeCreateAppModal = () => setShowCreateAppModal(false)
  ...
  return (
    <div className='d-flex align-items-center gap-2 gap-lg-3'>
      ...
      {config.app?.toolbar?.primaryButton && (
        <a href='#' onClick={openCreateAppModal} className='btn btn-sm fw-bold btn-primary'>
          Create
        </a>
      )}
      <CreateAppModal show={showCreateAppModal} handleClose={closeCreateAppModal} />
    </div>
  )
}
