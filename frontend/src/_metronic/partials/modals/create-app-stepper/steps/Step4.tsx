...
const Step4 = ({data, updateData}: StepProps) => {
  ...
  const handleAppStorageChangeBS = () => {
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleAppStorageChangeBS}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleAppStorageChange}
                />
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  onChange={handleGoogleAppStorage}
                />
              </span>
            </label>
            {/*end::Option */}
